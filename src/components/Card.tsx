...
function Card({ icon, title, route }: option) {
  return (
    <Link
      href={`${route}`}
      className="w-28 lg:w-48 h-28 lg:h-48 lg:max-w-xs bg-primaryGreen-500 text-slate-100 hover:scale-105 rounded-md hover:text-secondaryYellow transition-all"
    >
